...
Loads Qwen2.5-Coder-1.5B (small, fast), applies the same response-only
...
def main():
    ...
    # Filter for an example that has multi-turn system output
    # Let's find one with multiple messages
    ...
    # Now check the labels for the first example
