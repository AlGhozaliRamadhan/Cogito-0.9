"""
merge_shards.py — Merge all Cogito dataset shards into a single master JSONL.
...
OUTPUT_FILE = os.path.join(os.path.dirname(__file__), "..", "..", "data", "cogito_0.9_master_dataset.jsonl")
...
def main():
    ...
    if hf_token:
        ...
        try:
            ...
            ds.push_to_hub("ozaa77/Cogito-0.9.1-dataset", token=hf_token)
            print(f"[HF] Dataset push successful! Available at: https://huggingface.co/datasets/ozaa77/Cogito-0.9.1-dataset")
